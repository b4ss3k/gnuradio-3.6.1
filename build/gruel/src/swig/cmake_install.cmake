# Install script for directory: /home/zitouni/gnuradio-3.6.1/gruel/src/swig
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_python")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt/_pmt_swig.so" AND
    ...
    FILE(RPATH_CHECK
         ...
         RPATH "")
  ENDIF()
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt" TYPE MODULE FILES "/home/zitouni/gnuradio-3.6.1/build/gruel/src/swig/_pmt_swig.so")
  IF(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt/_pmt_swig.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt/_pmt_swig.so")
    FILE(RPATH_REMOVE
         FILE "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt/_pmt_swig.so")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_python")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt" TYPE FILE FILES "/home/zitouni/gnuradio-3.6.1/build/gruel/src/swig/pmt_swig.py")
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_python")

IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_python")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/python2.7/dist-packages/gruel/pmt" TYPE FILE FILES
    "/home/zitouni/gnuradio-3.6.1/build/gruel/src/swig/pmt_swig.pyc"
    "/home/zitouni/gnuradio-3.6.1/build/gruel/src/swig/pmt_swig.pyo"
    )
ENDIF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_python")
...
IF(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "gruel_swig")
  FILE(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/gruel/swig" TYPE FILE FILES
    "/home/zitouni/gnuradio-3.6.1/gruel/src/swig/gr_intrusive_ptr.i"
    "/home/zitouni/gnuradio-3.6.1/gruel/src/swig/pmt_swig.i"
    "/home/zitouni/gnuradio-3.6.1/gruel/src/swig/gruel_common.i"
    "/home/zitouni/gnuradio-3.6.1/build/gruel/src/swig/pmt_swig_doc.i"
    )
